...
def style(content_image, style_image):
    ...
    train_step(image, extractor, opt, style_targets, style_weight, num_style_layers, content_weight, num_content_layers, content_targets)
    train_step(image, extractor, opt, style_targets, style_weight, num_style_layers, content_weight, num_content_layers, content_targets)
    train_step(image, extractor, opt, style_targets, style_weight, num_style_layers, content_weight, num_content_layers, content_targets)
...
if __name__ == "__main__":
    ...
    content = load_img(img_path)
    style = load_img("./styles/leather2.jpg")
